...
{
    class ToBeIgbo : WordIgbo
    {

        public override void setStemSounds()
        {
            propStemSounds[0] = propSoundFolder + "/ToBe/wav/0_be.wav";
            propStemSounds[1] = propSoundFolder + "/ToBe/wav/1_be.wav";
            propStemSounds[2] = propSoundFolder + "/ToBe/wav/2_be.wav";
            propStemSounds[3] = propSoundFolder + "/ToBe/wav/3_be.wav";
            propStemSounds[4] = propSoundFolder + "/ToBe/wav/4_be.wav";
            propStemSounds[5] = propSoundFolder + "/ToBe/wav/5_be.wav";
            propStemSounds[6] = propSoundFolder + "/ToBe/wav/6_be.wav";
            propStemSounds[7] = propSoundFolder + "/ToBe/wav/7_be.wav";
            propStemSounds[8] = propSoundFolder + "/ToBe/wav/8_be.wav";
            propStemSounds[9] = propSoundFolder + "/ToBe/wav/9_be.wav";
        }
